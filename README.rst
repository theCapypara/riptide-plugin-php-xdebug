...
.. |build| image:: https://img.shields.io/github/workflow/status/Parakoopa/riptide-plugin-php-xdebug/Build,%20test%20and%20publish
    :target: https://github.com/Parakoopa/riptide-plugin-php-xdebug/actions
    :alt: Build Status
